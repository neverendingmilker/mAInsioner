...
const COMMAND_MANIFEST = [
  ...
  },
  {
    ...
    subcommands: [
      ...
      { name: 'edit', tier: MOD, permission: null, note: 'the configured Mod role, or Administrator' },
      { name: 'list', tier: MOD, permission: null, note: 'the configured Mod role, or Administrator' },
      { name: 'exempt add/remove/list', tier: MOD, permission: null, note: 'the configured Mod role, or Administrator' },
      { name: 'disable', tier: MOD, permission: null, note: 'the configured Mod role, or Administrator' },
    ],
  },
  {
    ...
    command: '/comboroles',
    subcommands: [
      { name: 'search', tier: MOD, permission: null, note: 'the configured Mod role, or Administrator' },
      { name: 'disable', tier: ADMIN, permission: PermissionFlagsBits.Administrator },
    ],
  },
  {
    ...
    command: '/commandlist',
    subcommands: [{ name: '(the command itself)', tier: MOD, permission: null, note: 'the configured Mod role, or Administrator' }],
  },
  {
  ...
  {
    feature: 'Reaction Limit',
    command: '/reactionlimit',
    subcommands: [
      { name: 'add', tier: ADMIN, permission: PermissionFlagsBits.Administrator },
      { name: 'remove', tier: ADMIN, permission: PermissionFlagsBits.Administrator },
      { name: 'edit', tier: ADMIN, permission: PermissionFlagsBits.Administrator },
    ...
    subcommands: [
      {
        ...
        tier: MOD,
        permission: null,
        note: 'the configured Mod role, or Administrator; shares state with /warning',
      },
    ],
  },
  {
